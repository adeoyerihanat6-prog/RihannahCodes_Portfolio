        ...
        >
          ...
          <div className="mt-16 grid gap-14 border-t border-[var(--border)] pt-12 lg:grid-cols-[1.15fr_0.85fr] lg:gap-24 lg:pt-14">
            ...
            <div>
              ...
              <h2 className="max-w-3xl font-serif text-4xl leading-[1.05] tracking-[-0.035em] text-[var(--foreground)] sm:text-5xl lg:text-6xl">
            ...
            <div className="lg:pt-1">
              ...
              <div className="border-b border-[var(--border)] pb-10">
                ...
                <p className="max-w-md text-lg leading-7 text-[var(--foreground)]">
                  Learning, building, experimenting, and finding better ways
                  to solve problems.
                </p>
              </div>
